...
export const GET = async (request) => {
  ...
  if (studentId) {
    ...
    const students = [];
    //your code here
    for(const student_id of studentIdList){
      const student_again = DB.students.find((x) => x.studentId === student_id);
      students.push(student_again);
    }
